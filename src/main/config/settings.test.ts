...
describe('activePetId', () => {
  ...
  it('归一化后 schemaVersion 升为 17', () => {
    const f = tmpSettingsFile({ schemaVersion: 3 })
    expect(loadSettings(f).schemaVersion).toBe(17)
  })
})
